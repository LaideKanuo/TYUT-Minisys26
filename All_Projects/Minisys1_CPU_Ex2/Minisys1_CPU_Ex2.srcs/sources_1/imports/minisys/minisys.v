...
module minisys (
    ...
    output  [7:0]   seg,                // 7-segment segment select
    ...
    wire zero;
    wire memwrite;
    wire memoriotoreg;                  // MemorIOtoReg from control32
    wire sftmd;
    wire [1:0] aluop;
    ...
    wire [13:0] rom_adr;
    wire [31:0] rom_dat;
    wire ledctrl, switchctrl, digitubectrl;
    wire [15:0] ioread_data_switch;
    wire [15:0] ioread_data_digitube;
    wire rst;
    // UART Programmer Pinouts
    ...
    // IO address decode input for control32
    ...
    control32 control(
        ...
        .Alu_resultHigh (alu_result_high),
    ...
    digitube digitube (
        .clk            (clock),
        .rst            (rst),
        .digitube_cs    (digitubectrl),
        .digitube_write (iowrite),
        .digitube_addr  (alu_result[3:2]),
        .write_data     (write_data[15:0]),
        .digitube_rdata (ioread_data_digitube),
        .seg            (seg),
        .an             (an)
    );
